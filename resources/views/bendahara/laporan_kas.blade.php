...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 max-w-xl mx-auto text-center">
    ...
    <h2 class="text-xl font-bold text-slate-900">Laporan Kas Gereja</h2>
    <p class="text-sm text-slate-500 mt-2 leading-relaxed">
        Halaman rekapitulasi, pencetakan, dan filter Laporan Kas Gereja (Pemasukan, Pengeluaran, dan Saldo).
    </p>
